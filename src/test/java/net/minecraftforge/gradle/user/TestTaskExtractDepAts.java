...
public class TestTaskExtractDepAts extends TaskTest<TaskExtractDepAts>
{
    ...
    public void runTask() throws IOException
    {
        ...
        FileCollectionInternal filesCollection = new FileCollectionAdapter(new SingletonFileSet(modWithAtJar, modWithAtJar.getName()));
        project.getConfigurations().maybeCreate("test_at").getDependencies().add(new DefaultSelfResolvingDependency(filesCollection));
